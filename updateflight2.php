...
if ($count == 0) {
  ...
  $sql= "SELECT Name,Source,Destination,Departure,Arrival,Fair_Economic,Fair_Business,Fair_VIP FROM flights WHERE Id = $flight_id";
  ...
  <div class="wrapper">
    <form action="updateflight3.php" method="post">
      ...
      VIP Fair:  <input type="number"  name="Fair_VIP" value="<?php echo $row['Fair_VIP']; ?>" required></input><br><br>
